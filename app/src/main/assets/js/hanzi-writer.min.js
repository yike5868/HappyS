...
function(t) {
  ...
  "use strict"; (function(i) {
    ...
    e = function(t) {
      for (var i = Object(t), n = arguments.length, r = Array(n > 1 ? n - 1 : 0), o = 1; o < n; o++) r[o - 1] = arguments[o];
      return r.forEach(function(t) {
        if (null != t) for (var n in t) Object.prototype.hasOwnProperty.call(t, n) && (i[n] = t[n])
      }),
      i
    },
    u = Object.assign || e;
    ...
    t.exports = {
      ...
      copyAndMergeDeep: function t(i, r) {
        ...
        for (var s in r) {
          var e = i[s],
          h = r[s];
          e !== h && (e && h && "object" === (void 0 === e ? "undefined": n(e)) && "object" === (void 0 === h ? "undefined": n(h)) && !Array.isArray(h) ? o[s] = t(e, h) : o[s] = h)
        }
        return o
      },
      counter: function() {
...
function(t, i, n) {
  "use strict"; (function(i) {
    ...
    u.init = function(t) {
      ...
      "SVG" === a || "G" === a ? s = h: (s = o("svg"), h.appendChild(s)),
      e(s, {
        width: n,
        height: r
      });
    ...
    t.exports = {
      ...
      urlIdRef: function(t) {
        var n = "";
        return i.location && i.location.href && (n = i.location.href.replace(/#[^#]*$/, "")),
        "url(" + n + "#" + t + ")"
      }
    }
  }).call(i, n(3))
...
function(t, i, n) {
  ...
  f = function(t) {
    ...
    return t.slice(1).forEach(function(t) {
      var r = n[n.length - 1],
      o = h(t, r);
      if (o > i) for (var s = Math.ceil(o / i), e = o / s, u = 0; u < s; u++) n.push(c(t, r, -1 * e * (u + 1)));
      else n.push(t)
    }),
    n
  },
  v = function(t) {
    for (var i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 30, n = a(t) / (i - 1), r = [t[0]], o = s(t), e = t.slice(1), u = 0; u < i - 2; u++) for (var f = s(r), v = n, l = !1; ! l;) {
      var d = h(f, e[0]);
      if (d < v) v -= d,
      f = e.shift();
      else {
  ...
  t.exports = {
    ...
    frechetDist: function(t, i) {
      ...
      return function r(o, s) {
        return n[o][s] > -1 ? n[o][s] : (n[o][s] = 0 === o && 0 === s ? h(t[0], i[0]) : o > 0 && 0 === s ? Math.max(r(o - 1, 0), h(t[o], i[0])) : 0 === o && s > 0 ? Math.max(r(0, s - 1), h(t[0], i[s])) : o > 0 && s > 0 ? Math.max(Math.min(r(o - 1, s), r(o - 1, s - 1), r(o, s - 1)), h(t[o], i[s])) : 1 / 0, n[o][s])
...
function(t, i, n) {
  ...
  h.prototype.run = function(t) {
    var i = this;
    return this.k || this.C(t),
    0 === this.h && t.updateState(this.k),
    0 === this.h ||
    function t(i, n) {
      ...
      return ! 0
    } (t.state, this.k) ? Promise.resolve() : (this.M = t, this.S = t.state, this.P = s(), this.j = e(this.v), new Promise(function(t) {
      i.F = t
    }))
  },
  h.prototype.w = function(t) {
    var i, n = Math.min(1, (t - this.P) / this.h);
    if (1 === n) this.M.updateState(this.k),
    this.j = null,
    this.cancel(this.M);
    else {
  ...
  h.prototype.C = function(t) {
    var i = this.u;
    "function" == typeof this.u && (i = this.u(t.state)),
  ...
  h.prototype.cancel = function(t) {
    ...
    this.j && u(this.j),
    this.j = null,
    this.f && (this.k || this.C(t), t.updateState(this.k))
  },
  ...
  "use strict"; (function(i) {
    ...
    function g() {
      if (arguments.length > 0) {
        ...
        arguments.length > 1 && ("string" == typeof(arguments.length <= 1 ? void 0 : arguments[1]) ? (console.warn("Using new HanziWriter() to set a character is deprecated. Use HanziWriter.create() instead"), t = arguments.length <= 1 ? void 0 : arguments[1], i = (arguments.length <= 2 ? void 0 : arguments[2]) || {}) : i = arguments.length <= 1 ? void 0 : arguments[1]),
        this.D(n, i),
    ...
    g.prototype.showCharacter = function() {
      ...
      return this.A.showCharacter = !0,
      this.U(function() {
        return t.M.run(f.showCharacter("main", t.I, "number" == typeof i.duration ? i.duration: t.A.strokeFadeDuration)).then(function(t) {
    ...
    g.prototype.hideCharacter = function() {
      var t = this,
      i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
      return this.A.showCharacter = !1,
      this.U(function() {
        return t.M.run(f.hideCharacter("main", t.I, "number" == typeof i.duration ? i.duration: t.A.strokeFadeDuration)).then(function(t) {
          return d(i.onComplete, t)
        })
      })
    },
    g.prototype.animateCharacter = function() {
      ...
      this.U(function() {
        return t.M.run(f.animateCharacter("main", t.I, t.A.strokeFadeDuration, t.A.strokeAnimationSpeed, t.A.delayBetweenStrokes)).then(function(t) {
          return d(i.onComplete, t)
        })
      })
    },
    ...
    g.prototype.loopCharacterAnimation = function() {
      ...
      return this.cancelQuiz(),
      this.U(function() {
        return t.M.run(f.animateCharacterLoop("main", t.I, t.A.strokeFadeDuration, t.A.strokeAnimationSpeed, t.A.delayBetweenStrokes, t.A.delayBetweenLoops), {
          loop: !0
        })
      })
    },
    g.prototype.showOutline = function() {
      var t = this,
      i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
      return this.A.showOutline = !0,
      this.U(function() {
        return t.M.run(f.showCharacter("outline", t.I, "number" == typeof i.duration ? i.duration: t.A.strokeFadeDuration)).then(function(t) {
          return d(i.onComplete, t)
        })
      })
    },
    g.prototype.hideOutline = function() {
      var t = this,
      i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
      return this.A.showOutline = !1,
      this.U(function() {
        return t.M.run(f.hideCharacter("outline", t.I, "number" == typeof i.duration ? i.duration: t.A.strokeFadeDuration)).then(function(t) {
          return d(i.onComplete, t)
        })
      })
    },
    g.prototype.updateColor = function(t, i) {
      ...
      return this.U(function() {
        ...
        return "radicalColor" !== t || i || (u = u.concat(f.updateColor(t, null, 0))),
        n.M.run(u).then(function(t) {
    ...
    g.prototype.setCharacter = function(t) {
      ...
      this.z = this.H.loadCharData(t).then(function(n) {
        if (!i.H.loadingFailed) {
          ...
          i._.mount(i.R, i.M.state),
          i._.render(i.M.state)
        }
      }),
      this.z
    },
    g.prototype.D = function(t, i) {
      return this.R = h.Canvas.init(t, i.width, i.height),
      this.R.svg.createSVGPoint && (this.G = this.R.svg.createSVGPoint()),
      this.A = this.N(i),
      this.H = new c(this.A),
      this.$(),
      this.L = null,
    ...
    g.prototype.$ = function() {
      var t = this;
      this.R.svg.addEventListener("mousedown",
      function(i) { ! t.isLoadingCharData && t.L && (i.preventDefault(), t.B("startUserStroke", t.V(i)))
      }),
      this.R.svg.addEventListener("touchstart",
      function(i) { ! t.isLoadingCharData && t.L && (i.preventDefault(), t.B("startUserStroke", t.J(i)))
      }),
      this.R.svg.addEventListener("mousemove",
      function(i) { ! t.isLoadingCharData && t.L && (i.preventDefault(), t.B("continueUserStroke", t.V(i)))
      }),
      this.R.svg.addEventListener("touchmove",
      function(i) { ! t.isLoadingCharData && t.L && (i.preventDefault(), t.B("continueUserStroke", t.J(i)))
      }),
      i.document.addEventListener("mouseup",
      function() {
        return t.B("endUserStroke")
      }),
      i.document.addEventListener("touchend",
      function() {
        return t.B("endUserStroke")
      })
    },
    g.prototype.B = function(t) {
      ...
      if (this.L) {
        ...
        r = Array(n > 1 ? n - 1 : 0), o = 1; o < n; o++) r[o - 1] = arguments[o]; (i = this.L)[t].apply(i, r)
      }
    },
    g.prototype.V = function(t) {
      if (this.G) {
        this.G.x = t.clientX,
        this.G.y = t.clientY;
        var i = this.G.matrixTransform(this.R.svg.getScreenCTM().inverse());
        return {
          x: i.x,
          y: i.y
        }
    ...
    g.prototype.J = function(t) {
      if (this.G) {
        this.G.x = t.touches[0].clientX,
        this.G.y = t.touches[0].clientY;
        var i = this.G.matrixTransform(this.R.svg.getScreenCTM().inverse());
        return {
          x: i.x,
          y: i.y
  ...
  u.prototype.render = function(t) {
    ...
    Object.keys(n).forEach(function(r) {
      if (n[r]) {
        ...
        n[r]),
        u = i.X[r];
        u || ((u = new o).mount(i.Y, e), i.X[r] = u),
        u.render(e)
      }
    })
  },
  u.prototype.destroy = function() {
    e.removeElm(this.Y.svg),
    this.Y.defs.innerHTML = ""
  },
  t.exports = u
},
function(t, i, n) {
  ...
  o.prototype.render = function(t) {
    if (t !== this.tt) {
      t.opacity !== this.tt.opacity && (this.it.style.opacity = t.opacity, 0 === t.opacity ? this.it.style.display = "none": 0 === this.tt.opacity && (this.it.style.display = "initial"));
      var i = !this.tt || t.strokeColor !== this.tt.strokeColor || t.radicalColor !== this.tt.radicalColor;
      if (i || t.strokes !== this.tt.strokes) for (var n = 0; n < this.strokeRenderers.length; n++) ! i && this.tt.strokes && t.strokes[n] === this.tt.strokes[n] || this.strokeRenderers[n].render({
...
function(t, i, n) {
  ...
  a.prototype.mount = function(t) {
    ...
    o.attr(this.ot, "clip-path", o.urlIdRef(i));
    var n = function(t, i) {
    ...
    return o.attr(this.ot, "d", o.getPathString(n)),
    o.attrs(this.ot, {
      stroke: "#FFFFFF",
      "stroke-width": h,
      fill: "none",
...
function(t, i, n) {
  ...
  o.prototype.mount = function(t) {
    this.at = r.createElm("path"),
    t.svg.appendChild(this.at)
  },
  o.prototype.render = function(t) {
    if (t !== this.tt) {
      ...
      t.opacity !== this.tt.opacity && r.attr(this.at, "opacity", t.opacity),
      t.points !== this.tt.points && r.attr(this.at, "d", r.getPathString(t.points)),
      this.tt = t
    }
  },
  ...
  e.prototype.cancelMutations = function(t) {
    ...
    this.ft.forEach(function(n) {
      n.yt.forEach(function(r) {
        t.forEach(function(t) { (r.indexOf(t) >= 0 || t.indexOf(r) >= 0) && i.gt(n)
        })
      })
    })
  },
...
function(t, i, n) {
  ...
  o.prototype.mt = function() {
    ...
    this.kt = -1 * t[0].x * this.bt + h,
    this.Ct = -1 * t[0].y * this.bt + a
  },
  t.exports = o
},
function(t, i, n) {
  ...
  l.prototype.startQuiz = function(t) {
    ...
    this.Pt = 0,
    this.jt = [],
    this.M.run(h.startQuiz(this.I, t.strokeFadeDuration))
  },
  l.prototype.startUserStroke = function(t) {
    ...
    var n = u();
    this.xt = new o(n, i, t),
    this.M.run(h.startUserStroke(n, i))
  },
  ...
  l.prototype.endUserStroke = function() {
    if (this.xt) if (this.M.run(h.removeUserStroke(this.xt.id, this.A.drawingFadeDuration)), 1 !== this.xt.points.length) {
      var t = this.Ft(),
      i = this.M.state.character.outline.opacity > 0;
      r(this.xt, this.I, this.Mt, {
        isOutlineVisible: i,
        leniency: this.A.leniency
      }) ? this.Ot(t) : (this.Dt(), this.St >= this.A.showHintAfterMisses && this.M.run(h.highlightStroke(t, this.A.highlightColor, this.A.strokeHighlightSpeed))),
      this.xt = null
    } else this.xt = null
  },
  l.prototype.cancel = function() {
    this.vt = !1,
    this.xt && this.M.run(h.removeUserStroke(this.xt.id, this.A.drawingFadeDuration))
  },
  l.prototype.Ot = function(t) {
    ...
    this.Mt += 1,
    this.St = 0,
    this.Mt === this.I.strokes.length && (this.vt = !1, e(this.A.onComplete, {
      character: this.I.symbol,
      totalMistakes: this.Pt
    }), this.A.highlightOnComplete && (i = i.concat(h.highlightCompleteChar(this.I, this.A.highlightCompleteColor, 2 * this.A.strokeHighlightDuration)))),
    this.M.run(i)
  },
...
function(t, i, n) {
  ...
  w = function(t, i, n) {
    ...
    var f, w, g, m, k, b, C, M, S, P, j, x, F = (f = t, g = o, m = c((w = i).getStartingPoint(), f[0]), k = c(w.getEndingPoint(), f[f.length - 1]), m <= 250 * g && k <= 250 * g),
    O = p(t, i),
    D = (b = t, C = i.points, M = o, S = v(b), P = v(C), j = 1 / 0, y.forEach(function(t) {
      var i = a(S, l(P, t));
      i < j && (j = i)
    }), j <= .4 * M),
...
function(t, i, n) {
  ...
  function r(t, i, n) {
    this.id = t,
    this.points = [i],
    this.externalPoints = [n]
  }
  r.prototype.appendPoint = function(t, i) {
    this.points.push(t),
    this.externalPoints.push(i)
  },
  t.exports = r
},
function(t, i, n) {
...
function(t, i, n) {
  "use strict"; (function(i) {
    t.exports = function(t, n, r) {
      ...
      o.open("GET", "https://cdn.jsdelivr.net/npm/hanzi-writer-data@2.0/" + t + ".json", !0),
...
function(t, i, n) {
  ...
  o.prototype.Et = function(t, i) {
    var n = this,
    r = function(t) {
      i === n.At && n.F(t)
    },
    o = this.A.charDataLoader(t, r,
    function(t) {
      i === n.At && n.Lt(t)
    });
    o && r(o)
  ...
  o.prototype.Tt = function() {
    var t = this;
    this.It = new Promise(function(i, n) {
      t.F = i,
      t.Lt = n
    }).then(function(i) {
      return t.Ut = !1,
      r(t.A.onLoadCharDataSuccess, i),
      i
    },
    function(i) {
